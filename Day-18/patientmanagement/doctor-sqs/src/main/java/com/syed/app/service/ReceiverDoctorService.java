...
@Configuration
public class ReceiverDoctorService {


    private static final Logger log = LoggerFactory.getLogger(ReceiverDoctorService.class);
    private final SqsAsyncClient sqsAsyncClient;
    private final ObjectMapper objectMapper;

    public ReceiverDoctorService(SqsAsyncClient sqsAsyncClient, ObjectMapper objectMapper) {
